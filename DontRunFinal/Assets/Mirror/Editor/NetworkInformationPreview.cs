...
namespace Mirror
{
    ...
    class NetworkInformationPreview : ObjectPreview
    {
        ...
        class Styles
        {
            ...
            public Styles()
            {
                // EditorStyles can be null during certain editor initialization/layout moments,
                // which would otherwise throw a NullReferenceException.
                labelStyle = new GUIStyle(EditorStyles.label ?? GUI.skin.label);
                componentName = new GUIStyle(EditorStyles.boldLabel ?? GUI.skin.label);
                disabledName = new GUIStyle(EditorStyles.miniLabel ?? GUI.skin.label);
        ...
        public override void OnPreviewGUI(Rect r, GUIStyle background)
        {
            ...
            // Lazy init styles to avoid EditorStyles null during inspector initialization.
            styles ??= new Styles();
