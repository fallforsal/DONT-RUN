...
public class Interactable : NetworkBehaviour
{
    ...
    protected virtual void StopInteraction()
    {
        ...
        // Restore player control when task is completed or cancelled
        if (playerMovement != null)
    ...
    void HandleTaskCompleted()
    {
        ...
        taskCompleteUI?.ShowComplete();

        // Notify the server that this task is complete (clients forward via Command)
        if (TaskManager.Instance != null)
